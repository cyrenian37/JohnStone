...
namespace SunSeven.Reports.ReportModel
{
    ...
    /// </summary>
    public partial class Invoice : Telerik.Reporting.Report
    {
        public Invoice()
        {
            //
        ...
        public Invoice(HSOrder lOrder, ObservableCollection<HSOrderItem> lOrderItems)
        {
            ...
            lparams[0].Value = Environment.MachineName; // +" : " + SunSeven.Views.MainPage.lCurrentUser.Employee.Person.LastName;
